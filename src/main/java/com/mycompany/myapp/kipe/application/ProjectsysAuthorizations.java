...
import com.mycompany.myapp.authentication.application.AuthenticatedUser;
import com.mycompany.myapp.authentication.domain.Role;
import com.mycompany.myapp.authentication.domain.Roles;
import com.mycompany.myapp.authentication.domain.Username;
import com.mycompany.myapp.kipe.domain.Action;
import com.mycompany.myapp.kipe.domain.Resource;
...
@Component
public class ProjectsysAuthorizations {

  private final RolesAccesses accesses;

  public ProjectsysAuthorizations(Collection<RolesAccesses> accesses) {
