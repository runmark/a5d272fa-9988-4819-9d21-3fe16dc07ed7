...
import static com.mycompany.myapp.kipe.domain.RolesAccessesFixture.*;

import java.util.List;
import java.util.stream.Stream;
import com.mycompany.myapp.UnitTest;
import com.mycompany.myapp.authentication.application.UnknownAuthenticationException;
import com.mycompany.myapp.authentication.domain.Username;
import com.mycompany.myapp.error.domain.MissingMandatoryValueException;
import com.mycompany.myapp.kipe.domain.RolesAccessesFixture.TestResource;
...
@UnitTest
class ProjectsysAuthorizationsTest {

  private static final ProjectsysAuthorizations authorizations = new ProjectsysAuthorizations(List.of(rolesAccesses()));
